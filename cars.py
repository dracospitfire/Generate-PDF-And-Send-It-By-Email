...
def process_data(data):
  ...
  pop_year_total_sales, pop_year = max(zip(car_years.values(), car_years.keys()))

  summary = [
    "The {} generated the most revenue: ${}".format(format_car(max_revenue["car"]), max_revenue["revenue"]),
    "The {} had the most sales: {}".format(format_car(max_sales["car"]), max_sales["total_sales"]),
    "The most popular year was {} with {} sales".format(pop_year, pop_year_total_sales)]
...
def cars_dict_to_table(car_data):
  ...
  for item in car_data:
    table_data.append([item["id"], format_car(item["car"]), item["pric$
  return table_data
